...
export const projects: Project[] = [
	{
		...
		description:
			"Public gallery of animated pets for Codex, Claude Code, OpenCode, and Gemini CLI",
	...
	},
	{
		...
		name: "Tinte",
		repo: "Railly/tinte",
		description: "Agent-native design system infrastructure for VS Code, shadcn, and more",
		url: "https://tinte.dev",
		icon: "tinte",
		featured: true,
	},
	...
	},
	{
		...
		description:
			"Browse, create, and edit AI agent files across Claude Code, Cursor, Codex, and 13+ tools",
	...
	},
	{
		...
		name: "Voxtype",
		repo: "Railly/voxtype",
		description: "3D typography in pure SVG - turn any text into voxel sculptures, zero WebGL",
	...
	},
	{
		...
		description: "Agent-powered knowledge system built on Obsidian + Claude Code + Codex",
	...
	},
	{
		...
		description: "Spotify Web API from your terminal - search, recommend, create playlists",
