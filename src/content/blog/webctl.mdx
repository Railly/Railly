...
If you want to skip the recon step and try the rest, the repo ships pre-generated IRs in [`examples/`](https://github.com/crafter-station/webctl/tree/main/examples):
