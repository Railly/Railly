...
pubDate: "2022-10-16"
slug: "og-image"
tags: ["vercel", "nextjs", "og-image"]
image: "/images/og-image-example.webp"
---
...
![Hello World OG Image](/images/hello-world.webp)
...
<Head>
  ...
  <meta
    property="og:image"
    content={`https://railly.dev/api/og?title=${blogPost.title}&date=${date}`}
  />
  ...
</Head>
```
...
![OG Image Example](/images/og-image-example.webp)
