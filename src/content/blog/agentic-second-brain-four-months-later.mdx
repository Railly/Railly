...
[`v1.0.0`](https://github.com/Railly/agent-brain/releases/tag/v1.0.0) preserves the March template. [`v2.0.0`](https://github.com/Railly/agent-brain/releases/tag/v2.0.0) adds canonical skills, portable adapters, a migration guide, and integrity checks. Existing vaults can update the workflow files without replacing their notes.
