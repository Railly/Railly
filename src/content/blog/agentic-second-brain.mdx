...
I open-sourced it: [`agent-brain` v1.0.0](https://github.com/Railly/agent-brain/releases/tag/v1.0.0).

<Callout type="note" title="Versioned snapshot">
  This article documents the March 2026 architecture preserved in [`v1.0.0`](https://github.com/Railly/agent-brain/tree/v1.0.0). The current template is [`v2.0.0`](https://github.com/Railly/agent-brain/releases/tag/v2.0.0), covered in [the four-month update](/blog/agentic-second-brain-four-months-later).
</Callout>
...
```bash
git clone --branch v1.0.0 https://github.com/Railly/agent-brain.git
...
The exact template described here is preserved in [`v1.0.0`](https://github.com/Railly/agent-brain/releases/tag/v1.0.0). For the current template, use [`v2.0.0`](https://github.com/Railly/agent-brain/releases/tag/v2.0.0). Open an issue if something is broken. And if you set it up and it changes how you work, I want to hear about it.
