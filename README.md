...
| Project | Description |
|---------|-------------|
| [Tinte](https://tinte.dev) | Theme builder for VS Code, shadcn, and more `580★` |
| [Agentfiles](https://github.com/Railly/agentfiles) | Browse, create, and edit AI agent files from Obsidian `508★` |
...
| [trx](https://github.com/crafter-station/trx) | Agent-first CLI for audio/video transcription `75★` |
<!-- END:PROJECTS -->
